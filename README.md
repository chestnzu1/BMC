...
Child terms of select GO terms from each method are retrieved by using QUICKGO API. Some selected terms are obsoleted.therefore, they are not included in this section. By using 
