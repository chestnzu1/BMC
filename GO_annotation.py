...
for method in method_name:
    ...
    for goid in golist:
        ...
        results_df.to_csv(saving_path+goid+'.csv')
        intermediates_df=pd.concat([intermediates_df,results_df])
    intermediates_df=intermediates_df.drop_duplicates()
    intermediates_df.to_csv(saving_path+'full.csv')